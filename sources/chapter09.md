...
If the reader takes away anything from the previous chapters of this book, it is that we have intelligence backwards. The smorgasbord of “cognitive” capabilities AGI researchers love to focus on are *only* meaningful in the context of survival. Without the primal environmental demands for these capabilities, these capabilities are poorly defined and cannot be trivially integrated together into a cohesive, functioning human-like intelligence. 
